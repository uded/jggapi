...
public class GGUserListReply implements GGIncomingPackage {
	...
	private final static int GG_USERLIST_PUT_REPLY  = 0x00;        /* poczÄ…tek eksportu listy */
	private final static int GG_USERLIST_PUT_MORE_REPLY  = 0x02;    /* kontynuacja */

	private final static int GG_USERLIST_GET_MORE_REPLY  = 0x04;    /* poczÄ…tek importu listy */
	private final static int GG_USERLIST_GET_REPLY = 0x06; 			/* ostatnia czÄ™Å›Ä‡ importu */ 
