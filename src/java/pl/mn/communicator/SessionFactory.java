...
// * @version $Id: SessionFactory.java,v 1.11 2005-01-25 23:51:42 winnetou25 Exp $
// */
...
//		IServer server = Server.getDefaultServer(loginContext.getUin());
//		return new Session();
//	}
//
//	/**
...
//	 * @return <code>ISession</code> instance.
//	 */
//	public static ISession createSession(String address, int port) {
