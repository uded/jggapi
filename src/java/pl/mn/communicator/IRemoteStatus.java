 ...
 * @version $Id: IRemoteStatus.java,v 1.2 2004-12-23 17:52:24 winnetou25 Exp $
 */
public interface IRemoteStatus extends IStatus {
     ...
     * It might return -1 if there is no information about remote ip of the user.
     * 
	 ...
	 * It might return -1 if there is not information about remote port of the user.
	 * 
	 ...
	 * 
	 * It might return -1 if there is not information about client's version.
	 * 
	 ...
	 * 
	 * It might return -1 if the user does not accept images at all.
	 * 
	 ...
	 * it might return -1 if there is no information about the description or description is not set.
	 * 
