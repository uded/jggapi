 ...
 * @version $Id: IPublicDirectoryService.java,v 1.7 2004-12-19 11:49:12 winnetou25 Exp $
 */
public interface IPublicDirectoryService {
	 ...
	 */
	void writeToPublicDirectory(PersonalInfo publicDirInfo) throws GGException;
